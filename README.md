# Decision Maker Finder - AI-Powered Executive Discovery

<div align="center">
  <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExNjJwMnF2cW5zbXBhbGV6NXBpb3lkZmVhMWEwY3hmdmt3d3ZtbWc5YSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/QhpbWI09KyFZ0rwD72/giphy.gif" alt="Decision Maker Finder Demo" width="100%" />
</div>

Find key decision makers and executives at any company. Upload a list of companies and discover CEOs, CTOs, CFOs, and custom roles. Powered by [Firecrawl](https://www.firecrawl.dev/) and enhanced with specialized decision maker detection.
...
```json
{
  ...
  "totalRaised": "$900M",
  // Decision Maker Data - Our Specialization
  "decisionMakers": [
    {
  ...
  "ceo": "Assaf Rappaport - CEO and Co-founder of Wiz, former Microsoft security executive",
  "cto": "Yinon Costica - CTO and Co-founder, leads technical strategy and product development",
